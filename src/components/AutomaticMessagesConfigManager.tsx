...
import { automaticMessagesConfigApi, AutomaticMessagesConfig, DiaHorarioEnvio } from '../services/automaticMessagesConfigApi';

const AutomaticMessagesConfigManager: React.FC = () => {
  const [config, setConfig] = useState<AutomaticMessagesConfig | null>(null);
  ...
  const loadConfig = async () => {
    setLoading(true);
    try {
      const response = await automaticMessagesConfigApi.getConfig();
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const response = await automaticMessagesConfigApi.updateConfig(config.id, {
        ...
        <div className="bg-primary text-white p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white !text-white">Configurações de Mensagens Automáticas</h2>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-medium text-gray-900">Status das Mensagens Automáticas</h3>
                </div>
                <div>
                  <div className="flex items-center gap-3">
                    <button
...
export default AutomaticMessagesConfigManager;
